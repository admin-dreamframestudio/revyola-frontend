          ...
          <div className="relative z-10 grid gap-10 xl:grid-cols-[1fr_520px] xl:items-center">
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl">
                Create your Revyola account
              </h1>

              <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
                Create secure access for demo workflows, guided product review,
                and reimbursement intelligence exploration.
              </p>

              <div className="mt-8 flex flex-wrap gap-3 text-sm text-slate-300">
                <MetaPill label="Setup" value="Fast account creation" />
                <MetaPill label="Access" value="Protected product workspace" />
                <MetaPill label="Next step" value="Demo or admin flow" />
              </div>
            </div>
